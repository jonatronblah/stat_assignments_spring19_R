...
exercise <- read_csv("C:\\Users\\jonathan\\Desktop\\DAPT Docs\\spring 2019\\Statistics\\stat_assignments_spring19_R\\stat_assignment5_R\\tutorial scripts & data\\Exercise.txt")
