#Football Data
football <- read.table("C:/Users/local_dedwards7/Desktop/R files/football.txt",sep=',',header=TRUE)
...
#Standardized coefficients are computed by multiplying the standard deviation of 
...
#Bank Data
library(MASS)
bank.data <- read.table("C:/Users/local_dedwards7/Desktop/R files/bank_data.txt",sep=',',header=TRUE)
