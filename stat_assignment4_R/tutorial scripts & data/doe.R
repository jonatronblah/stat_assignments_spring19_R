#Battery Brands Data
battery <- read_csv("C:\\Users\\jonathan\\Desktop\\DAPT Docs\\spring 2019\\Statistics\\stat_assignments_spring19_R\\stat_assignment4_R\\tutorial scripts & data\\BatteryBrands.txt")
...
#Two-Level Design
BHH <- read.table("C:\\Users\\jonathan\\Desktop\\DAPT Docs\\spring 2019\\Statistics\\stat_assignments_spring19_R\\stat_assignment4_R\\tutorial scripts & data\\BHH.txt",sep=',',header=TRUE)
...
marketing <- read.table("C:\\Users\\jonathan\\Desktop\\DAPT Docs\\spring 2019\\Statistics\\stat_assignments_spring19_R\\stat_assignment4_R\\tutorial scripts & data\\MarketingDOE.txt",sep=',',header=TRUE)
...
#Interaction plot
interaction.plot(marketing$Interest.Rate,marketing$Sticker,marketing$Response.Rate,type="o",pch=c(18,24))
